...
public class Luxury implements Car {
	private static final double ONE_MILE_COST=10;
	private static final double LUXURY_TAX=5;
	private static final boolean IS_INSAURABLE=true;
	private static final double INSAURANCE_PERCENTAGE= 4;
	private static final double DAMAGE_COST_PERCENTAGE=7.5/100;
	private static final double MINIMUM_DAMAGE=4.5;
	int carID;
    String carBrand;
    String carModel;
    int carYear;
	...
	public double calculateRentalFee() {
		// TODO Auto-generated method stub
		carRentalFee=BASE_RENT+(distanceCovered*ONE_MILE_COST)+LUXURY_TAX;
		return carRentalFee;
	}
